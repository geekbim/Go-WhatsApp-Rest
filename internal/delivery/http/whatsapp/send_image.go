...
func (handler *whatsAppHandler) SendImage(w http.ResponseWriter, r *http.Request) {
	...
	whatsApp, errValidate := entity.NewWhatsAppImage(&entity.WhatsAppImageDTO{
	...
	whatsAppImage, errUseCase := handler.whatsAppUseCase.SendImage(context.Background(), whatsApp)
	if errUseCase != nil {
