...
func (handler *orderHandler) GetOrderSeller(w http.ResponseWriter, r *http.Request) {
	var (
	...
	utils.RespondWithJSON(w, http.StatusOK, response.MapSellerOrderListDomainToResponse(orders, count))
}
